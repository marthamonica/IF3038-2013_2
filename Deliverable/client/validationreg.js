...
var valid7bool;
	...
	username.onkeyup = function()
	{
		...
		xmlhttp.open("GET","http://nicholasrio.ap01.aws.af.cm/rest/getuser?q="+username.value,true);
		xmlhttp.send();
	}
	...
	email.onkeyup = function()
	{
		...
		xmlhttp.open("GET","http://nicholasrio.ap01.aws.af.cm/rest/getemail?q="+email.value,true);
		xmlhttp.send();
	}
